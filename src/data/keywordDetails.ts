...
export const KEYWORD_DETAILS: Record<string, KeywordDetail> = {
        ...
        sections: [
            {
                ...
                paragraphs: [
                    ...
                    // [2026-09-16 1.0.16 T03] 原文案误写成「像拥有挑战者特权一样」，与机制方向相反：
                    //   挑战者 = 进攻方的权限（我锁定你）；暴露 = 防守方的漏洞（我被锁定）。
                    //   暴露【不需要任何激活动作】，是公开的，谁进攻都能用。
                    '作为极为致命的负面特性，敌方任何发起进攻的单位，都无需任何特权，即可直接把暴露的单位从备战席拉上场格挡。',
                    '【全局视角】卡面文案中的「我方 / 敌方」，一律以该单位脚下的那块盘为基准。'
                ]
            },
            {
                heading: '战术指引 // TACTICS',
    ...
    'Titan': {
        id: 'Titan', nameEn: 'TITAN', nameCn: '泰坦', testCardId: 'test_titan', availableModes: ['bench', 'combat'],
        sections: [
            {
                heading: '机制解密 // EFFECT',
                paragraphs: [
                    '泰坦物质具有在个体之间产生共鸣增幅的特性。',
                    '回合结束时，战场上的每一个泰坦单位都会与周围的泰坦物质产生共振，根据场上所有泰坦单位的总数获得等量的攻击力增幅。该脉冲仅会触发一次，此后泰坦物质进入惰性状态——关键词黯淡，不再响应后续脉冲，但依然维持着共振场的存在，持续计入下一次脉冲的计数基数。'
                ]
            },
            {
                heading: '战术指引 // TACTICS',
                paragraphs: [
                    '泰坦单位之间的"浓度联动"是其核心战术价值——铺场越多，单次脉冲的爆发力越强。',
                    '黯淡机制为进攻方提供了明确的时间窗口：你必须决定是在一回合内集中铺场打出一波大额脉冲，还是分批次施压让对手持续处于处理泰坦的被动节奏中。',
                    '注意：黯淡后的泰坦依然会计入场上泰坦数量，因此即使第一批泰坦已经脉冲过，后续登场的泰坦仍能享受到由它们构成的浓度加成。'
                ]
            }
        ]
    },
