const loadingImagesModules = import.meta.glob('../image/loading/*.webp', { eager: true });

// 转换为图片路径数组
export const LOADING_SCREEN_IMAGES = Object.values(loadingImagesModules).map((mod: any) => mod.default);

// [新增] 货币图标导入
import icon_silver from '../image/icon/silverCoin.webp';
import icon_data from '../image/icon/dataGold.webp';
import icon_bit from '../image/icon/bitGold.webp';

// [核心替换] 引入四阶状态升级图标
import icon_levelup_0 from '../image/icon/levelup_0.webp';
import icon_levelup_1 from '../image/icon/levelup_1.webp';
import icon_levelup_2 from '../image/icon/levelup_2.webp';
import icon_levelup_full from '../image/icon/levelup.webp';
import icon_leveldown from '../image/icon/leveldown.webp';

import border_hero from '../image/cardborder/cardborder_hero.webp';
import border_spell from '../image/cardborder/cardborder_spell.webp';
import border_unit from '../image/cardborder/cardborder_unit.webp';

// [新增] 引入局内视觉特效贴图
import effect_break from '../image/effect/break.webp';
import effect_broken1 from '../image/effect/broken1.webp';
import effect_broken2 from '../image/effect/broken2.webp';
import effect_be_attacked from '../image/effect/be_attacked.webp'; // [核心新增] 引入全新的法术命中受击贴图
import mauxir_rush_attack from '../image/effect/mauxir_lotus_rush_attack.webp';
...
import effect_healing from '../image/effect/Healing.webp';

// 引入里芙的原画
import lyfe_1 from '../image/hero/里芙1.webp';
import lyfe_2 from '../image/hero/里芙2.webp';

// 引入芬妮的原画
import fenny_1 from '../image/hero/芬妮1.webp';
import fenny_2 from '../image/hero/芬妮2.webp';

// 引入卜卜 灵鉴的原画
import pupu_specular_soul_1 from '../image/hero/卜卜灵鉴1.webp';
import pupu_specular_soul_2 from '../image/hero/卜卜灵鉴2.webp';

// [新增] 引入猫汐尔 莲驱的原画
import mauxir_lotus_drive_1 from '../image/hero/猫汐尔莲驱1.webp';
import mauxir_lotus_drive_2 from '../image/hero/猫汐尔莲驱2.webp';
...
// --- 法术卡面 (Spells) ---
// 通用法术
import spell_01 from '../image/spells/01.webp'; // 单挑
import spell_02 from '../image/spells/02.webp'; // 祈祷
import spell_03 from '../image/spells/03.webp'; // 专注
import spell_04 from '../image/spells/04.webp'; // 暗箭
import spell_05 from '../image/spells/05.webp'; // 振奋
import spell_06 from '../image/spells/06.webp'; // 破坏
// [新增] 5 大新法术的图片载入
import spell_07 from '../image/spells/07.webp'; // 活力再生
import spell_08 from '../image/spells/08.webp'; // 全力净化
// [新增] 第 4 批通用法术原画
import spell_09 from '../image/spells/09.webp'; // 暗箱操作
import spell_10 from '../image/spells/10.webp'; // 生机补充
import spell_11 from '../image/spells/11.webp'; // 能量补充
import spell_12 from '../image/spells/12.webp'; // 巴德尔试剂
import spell_13 from '../image/spells/13.webp'; // 鬼影森森
import spell_14 from '../image/spells/14.webp'; // 毁灭仪式
import spell_15 from '../image/spells/15.webp'; // 蟾鉴易纹
import spell_16 from '../image/spells/16.webp'; // 强行通讯
import spell_17 from '../image/spells/17.webp'; // 精灵祈愿
import spell_18 from '../image/spells/18.webp'; // 真实快照

// [2026-07-15 梵音小队] 迷离之音 & 巨偶一瞥原画
import spell_19 from '../image/spells/19.webp'; // 迷离之音
import spell_20 from '../image/spells/20.webp'; // 巨偶一瞥
// [2026-07-16 达努小队] 银臂乱打原画
import spell_21 from '../image/spells/21.webp'; // 银臂乱打
// [2026-07-17 阿尔戈小队] 蓄意渗透原画
import spell_22 from '../image/spells/22.webp'; // 蓄意渗透
// [2026-07-17 鸦眼小队] 精密操作原画
import spell_23 from '../image/spells/23.webp'; // 精密操作

// [新增] 梦莲无人机原画
import dream_lotus_drone_img from '../image/spells/mauxir_lotus_robot.webp';

// 芬妮专属法术
import fenny_spell_base from '../image/spells/fenny_spell.webp';   // 芬妮的狂热
import fenny_spell_01 from '../image/spells/fenny_spell01.webp';  // 星光之途
import fenny_spell_02 from '../image/spells/fenny_spell02.webp';  // 绝对主角
import fenny_spell_03 from '../image/spells/fenny_spell03.webp';  // [新增] 激励之声

// 里芙专属法术
import lyfe_spell_base from '../image/spells/lyfe_spell.webp';    // 里芙的决意
import lyfe_spell_01 from '../image/spells/lyfe_spell01.webp';   // 无尽霜刃
import lyfe_spell_02 from '../image/spells/lyfe_spell02.webp';   // 吞噬神座
import lyfe_spell_03 from '../image/spells/lyfe_spell03.webp';   // [新增] 冻沙激流

// 卜卜灵鉴专属法术
import pupu_specular_soul_spell_base from '../image/spells/pupu_specular_soul_spell.webp';    // 卜卜的卜卦
import pupu_specular_soul_spell_01 from '../image/spells/pupu_specular_soul_spell01.webp';   // 镜涌万象
import pupu_specular_soul_spell_02 from '../image/spells/pupu_specular_soul_spell02.webp';   // 吉煞映照
import pupu_specular_soul_spell_03 from '../image/spells/pupu_specular_soul_spell03.webp';   // [新增] 异镜来物

// [新增] 猫汐尔莲驱专属法术
import mauxir_lotus_spell_base from '../image/spells/mauxir_lotus_spell.webp';    // 猫汐尔的战术演算
import mauxir_lotus_spell_01 from '../image/spells/mauxir_lotus_spell01.webp';   // 千莲叠绽
import mauxir_lotus_spell_02 from '../image/spells/mauxir_lotus_spell02.webp';   // 顷刻莲潮
...
import acacia_chrono_echo_spell_01 from '../image/spells/Acacia_Chrono Echo_spell01.webp';    // 剑咏变调
import acacia_chrono_echo_spell_02 from '../image/spells/Acacia_Chrono Echo_spell02.webp';    // 相变之力·扭转
import acacia_chrono_echo_spell_03 from '../image/spells/Acacia_Chrono Echo_spell03.webp';    // 时之协奏
import acacia_chrono_echo_spell_m1 from '../image/spells/Acacia_Chrono Echo_spell-1.webp';    // 安卡希雅的重锋
import acacia_chrono_echo_spell_01_m1 from '../image/spells/Acacia_Chrono Echo_spell01-1.webp'; // 越时斩
import acacia_chrono_echo_spell_02_m1 from '../image/spells/Acacia_Chrono Echo_spell02-1.webp'; // 剑痕时空
...
import spell_24 from '../image/spells/24.webp'; // 抵抗
import spell_25 from '../image/spells/25.webp'; // 抗拒
import spell_26 from '../image/spells/26.webp'; // 拒绝
import spell_27 from '../image/spells/27.webp'; // 战术回撤
import spell_28 from '../image/spells/28.webp'; // 战术闪击
import spell_29 from '../image/spells/29.webp'; // 单刀直入
import spell_30 from '../image/spells/30.webp'; // 降临事件
import spell_31 from '../image/spells/31.webp'; // 瓦尔哈拉的呼唤
import spell_32 from '../image/spells/32.webp'; // 深思熟虑
import spell_33 from '../image/spells/33.webp'; // 正面突破
import spell_34 from '../image/spells/34.webp'; // 迂回防守
// [2026-08-08 莉莉子] 泰坦系 + 冻结 法术真卡面
import spell_35 from '../image/spells/35.webp'; // 万钧齐鸣（泰坦脉冲）
import spell_36 from '../image/spells/36.webp'; // 泰坦重燃（点亮泰坦关键词）
import spell_37 from '../image/spells/37.webp'; // 急冻令（冻结单体）
// [2026-08-08 莉莉子] 最后一批法术真卡面（御剑归鞘/泰坦降临/神格共鸣/芬格尼尔之冬/破军/剑鸣回响）
import spell_38 from '../image/spells/38.webp'; // 御剑归鞘（撤回+飞剑1）
import spell_39 from '../image/spells/39.webp'; // 泰坦降临（燃尽召唤泰坦）
import spell_40 from '../image/spells/40.webp'; // 神格共鸣（三选天启者+2/+2）
import spell_41 from '../image/spells/41.webp'; // 芬格尼尔之冬（冻结全场+3伤）
import spell_42 from '../image/spells/42.webp'; // 破军（单体3伤+飞剑减费）
import spell_43 from '../image/spells/43.webp'; // 剑鸣回响（回响+飞剑2）

// [新增] 臆莲基座原画
import placeholder_pedestal from '../image/units/mauxir_lotus_pedestal.webp';

// [新增] 飞剑衍生物占位图
import abc_unit from '../image/units/abc.webp';

// --- 测试单位原画 (0_01 ~ 0_36) ---
// 1-10
import t_01 from '../image/attendants/0_01.webp';
import t_02 from '../image/attendants/0_02.webp';
import t_03 from '../image/attendants/0_03.webp';
import t_04 from '../image/attendants/0_04.webp';
import t_05 from '../image/attendants/0_05.webp';
import t_06 from '../image/attendants/0_06.webp';
import t_07 from '../image/attendants/0_07.webp';
import t_08 from '../image/attendants/0_08.webp';
import t_09 from '../image/attendants/0_09.webp';
import t_10 from '../image/attendants/0_10.webp';
// 11-20
import t_11 from '../image/attendants/0_11.webp';
import t_12 from '../image/attendants/0_12.webp';
import t_13 from '../image/attendants/0_13.webp';
import t_14 from '../image/attendants/0_14.webp';
import t_15 from '../image/attendants/0_15.webp';
import t_16 from '../image/attendants/0_16.webp';
import t_17 from '../image/attendants/0_17.webp';
import t_18 from '../image/attendants/0_18.webp';
import t_19 from '../image/attendants/0_19.webp';
import t_20 from '../image/attendants/0_20.webp';
// 21-30
import t_21 from '../image/attendants/0_21.webp';
import t_22 from '../image/attendants/0_22.webp';
import t_23 from '../image/attendants/0_23.webp';
import t_24 from '../image/attendants/0_24.webp';
import t_25 from '../image/attendants/0_25.webp';
import t_26 from '../image/attendants/0_26.webp';
import t_27 from '../image/attendants/0_27.webp';
import t_28 from '../image/attendants/0_28.webp';
import t_29 from '../image/attendants/0_29.webp';
import t_30 from '../image/attendants/0_30.webp';
// 31-36
import t_31 from '../image/attendants/0_31.webp';
import t_32 from '../image/attendants/0_32.webp';
import t_33 from '../image/attendants/0_33.webp';
import t_34 from '../image/attendants/0_34.webp';
import t_35 from '../image/attendants/0_35.webp';
import t_36 from '../image/attendants/0_36.webp';
import t_37 from '../image/attendants/0_37.webp'; // Titan 测试卡

// [新增] 引入按钮容器背景 (注意文件名拼写 buttton1)
import button_container from '../image/icon/buttton1.webp';
import title_logo from '../image/icon/titile.webp';
import sword_icon from '../image/icon/sword.webp';
import sword_gain_icon from '../image/icon/sword_gain.webp';
import spell_container from '../image/icon/spell.webp'; // [新增] 法术底托容器


// --- 水晶资源引入 ---
// 敌方 Mana (1-10)
import e_m_1 from '../image/icon/enemy_MANA_1.webp';
import e_m_2 from '../image/icon/enemy_MANA_2.webp';
import e_m_3 from '../image/icon/enemy_MANA_3.webp';
import e_m_4 from '../image/icon/enemy_MANA_4.webp';
import e_m_5 from '../image/icon/enemy_MANA_5.webp';
import e_m_6 from '../image/icon/enemy_MANA_6.webp';
import e_m_7 from '../image/icon/enemy_MANA_7.webp';
import e_m_8 from '../image/icon/enemy_MANA_8.webp';
import e_m_9 from '../image/icon/enemy_MANA_9.webp';
import e_m_10 from '../image/icon/enemy_MANA_10.webp';

// 我方 Mana (1-10)
import p_m_1 from '../image/icon/player_MANA_1.webp';
import p_m_2 from '../image/icon/player_MANA_2.webp';
import p_m_3 from '../image/icon/player_MANA_3.webp';
import p_m_4 from '../image/icon/player_MANA_4.webp';
import p_m_5 from '../image/icon/player_MANA_5.webp';
import p_m_6 from '../image/icon/player_MANA_6.webp';
import p_m_7 from '../image/icon/player_MANA_7.webp';
import p_m_8 from '../image/icon/player_MANA_8.webp';
import p_m_9 from '../image/icon/player_MANA_9.webp';
import p_m_10 from '../image/icon/player_MANA_10.webp';

// 敌方 Spells (1-3)
import e_s_1 from '../image/icon/enemy_spells_1.webp';
import e_s_2 from '../image/icon/enemy_spells_2.webp';
import e_s_3 from '../image/icon/enemy_spells_3.webp';

// 我方 Spells (1-3)
import p_s_1 from '../image/icon/player_spells_1.webp';
import p_s_2 from '../image/icon/player_spells_2.webp';
import p_s_3 from '../image/icon/player_spells_3.webp';

// [新增] 批量引入卡背 (1张默认 + 3张可抽取 + 3张英雄专属 + 6张永恒之约 = 13张满编)
import cb_01 from '../image/card_back/01.webp';
import cb_02 from '../image/card_back/02.webp';
import cb_03 from '../image/card_back/03.webp';
import cb_04 from '../image/card_back/04.webp';
import cb_fenny from '../image/card_back/fenny.webp';
import cb_lyfe from '../image/card_back/lyfe.webp';
import cb_pupu from '../image/card_back/pupu_specular.webp';
import cb_05 from '../image/card_back/05.webp';
import cb_06 from '../image/card_back/06.webp';
import cb_07 from '../image/card_back/07.webp';
import cb_08 from '../image/card_back/08.webp';
import cb_09 from '../image/card_back/09.webp';
import cb_10 from '../image/card_back/10.webp';
import cb_11 from '../image/card_back/11.webp';
...
import desk_02 from '../image/desk/02.webp';
import desk_03 from '../image/desk/03.webp';
import desk_04 from '../image/desk/04.webp';
import desk_05 from '../image/desk/05.webp';
import desk_06 from '../image/desk/06.webp';
import desk_07 from '../image/desk/07.webp';
...
// ==========================================
const unitImageModules = import.meta.glob('../image/units/*.webp', { eager: true }) as Record<string, { default: string }>;
...
for (const [fp, mod] of Object.entries(unitImageModules)) {
  const fn = fp.split('/').pop()?.replace('.webp', '');
...
import titan_type_b_mutant from '../image/enemy/Titan_Type_B_Mutant.webp';
import titan_hodu from '../image/enemy/Titan_Hodu.webp';
import titan_type_c_mutant from '../image/enemy/Titan_Type_C_Mutant.webp';
import titan_gonglu from '../image/enemy/Titan_Gonglu.webp';
import gonglu_support from '../image/enemy/Gonglu_support.webp'
import titan_type_d_mutant from '../image/enemy/Titan_Type_D_Mutant.webp';
import titan_gaimer from '../image/enemy/Titan_Gaimer.webp';
...
export const SPELL_IMAGES = {
    ...
    mauxir_yiying_tuoyin: mauxir_yiying_img,
    mauxir_ouduan_si_chang: mauxir_ouduan_img,
