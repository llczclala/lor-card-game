...
import { Settings, RefreshCw, Eye, EyeOff, Sword, Hexagon, Coins, Database } from 'lucide-react';
                ...
                {showUI && (
                    ...
                    >
                        ...
                        <div className="flex gap-4">
                            {/* 数据金 (Data Gold) */}
                            <div className="flex items-center gap-2 bg-black/40 backdrop-blur-md px-4 py-2 rounded-full border border-white/10 hover:border-white/30 transition-colors cursor-help" title="数据金">
                                <Database size={18} className="text-cyan-400" />
                                <span className="font-mono font-bold text-white tracking-widest">
                                    {collection?.resources.dataGold.toLocaleString() || 0}
                                </span>
                                <div className="w-4 h-4 bg-cyan-500 rounded-full flex items-center justify-center text-[10px] text-black font-bold">+</div>
                            </div>

                            {/* 比特金 (Bit Gold) */}
                            <div className="flex items-center gap-2 bg-black/40 backdrop-blur-md px-4 py-2 rounded-full border border-white/10 hover:border-white/30 transition-colors cursor-help" title="比特金">
                                <Coins size={18} className="text-yellow-400" />
                                <span className="font-mono font-bold text-white tracking-widest">
                                    {collection?.resources.bitGold.toLocaleString() || 0}
                                </span>
                            ...
                            >
                                ...
                                <div className="absolute inset-0 bg-gradient-to-r from-blue-600 to-blue-900 opacity-90 group-hover:opacity-100 border-2 border-blue-400/50 backdrop-blur-md flex items-center justify-center shadow-[0_0_30px_rgba(37,99,235,0.5)] clip-path-slant">
                                    <div className="flex flex-col items-center gap-2">
                                        ...
                                        <span className="text-2xl font-black italic tracking-[0.2em] text-white">BATTLE</span>
                                        <span className="text-[10px] text-blue-200 tracking-widest">OPERATION START</span>
                                    </div>
                                </div>
                                {/* 装饰性发光边 */}
                            ...
                            >
                                <div className="absolute inset-0 bg-gradient-to-r from-purple-600 to-purple-900 opacity-90 group-hover:opacity-100 border-2 border-purple-400/50 backdrop-blur-md flex items-center justify-center shadow-[0_0_30px_rgba(147,51,234,0.5)]">
                                    <div className="flex flex-col items-center gap-2">
                                        ...
                                        <span className="text-2xl font-black italic tracking-[0.2em] text-white">ECHO</span>
                                        <span className="text-[10px] text-purple-200 tracking-widest">SUPPLY DROP</span>
                                    </div>
                                </div>
                            </button>
                        </motion.div>
